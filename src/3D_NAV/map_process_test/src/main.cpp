...
int main(int argc, char** argv) {
    ros::init(argc, argv, "map_process_test_node");
    ros::NodeHandle nh;
    ...
    // Store intermediate debug files beside the requested output by default.
    const std::string output_dir = map_process::Utils::getParentDirectory(output_file);
    private_nh.param<std::string>("debug_output_dir", params.debug_output_dir, output_dir);
    ...
    std::cout << "  Debug output dir: " << params.debug_output_dir << std::endl;
    ...
    map_process::Utils::ensureDirectoryExists(output_dir);
