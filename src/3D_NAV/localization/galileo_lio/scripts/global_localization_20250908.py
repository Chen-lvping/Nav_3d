...
def cb_save_cur_scan(pc_msg):
    ...
    pc_msg.header.frame_id = parent_id
...
if __name__ == '__main__':
    ...
    rospy.init_node('galileo_localization')
    rospy.loginfo('Localization Node Inited...')

    parent_id = rospy.get_param('~parent_id', 'camera_init')
    child_id = rospy.get_param('~child_id', 'body')
