...
enum LID_TYPE{AVIA = 1, VELO16, OUST64, PANDAR32, RS16, MARSIM}; //{1, 2, 3, 4, 5, 6}
...
//   EIGEN_MAKE_ALIGNED_OPERATOR_NEW
  ...
  double blind;
  bool feature_enabled, given_offset_time, crop_box_enabled;
  double crop_x_min, crop_x_max, crop_y_min, crop_y_max, crop_z_min, crop_z_max;
