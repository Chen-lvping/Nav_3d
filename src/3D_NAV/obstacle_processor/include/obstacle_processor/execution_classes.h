...
namespace EXECUTION
{
    ...
    public:
        ...
        void setObsReverse(const Eigen::Vector3d &point);
         ...
         */
        Eigen::Vector3d
        coordRounding(const Eigen::Vector3d &coord);
        bool isOut(const Eigen::Vector3d &point);
        ...
        Eigen::Vector3i idx_count_; // 公开以便优化时访问
